...
// Фикстуры ниже смоделированы по структуре образцов из patterns/ (§4.8): иерархия
...
// сложности, а не спецификация парсера — импорт остаётся format-agnostic (§1.1 п.47).
